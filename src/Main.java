...
public class Main {
    ...
    private static void printMenu() {
        ...
        System.out.println("2 - Список всех задач, 2.1 - Список задач, 2.2 - Список эпик задач, 2.3 - Список подзадач");
        System.out.println("3 - Удаляет все задачи, 3.1 - Удаление задач, 3.2 - Удаление эпик задач, " +
